...
public class Refund {
    ...
    public Refund(Integer refundId, Integer paymentId, BigDecimal refAmount, String reason, RefundStatus status, LocalDateTime refundDate) {
    ...
    public static class RefundBuilder {
        ...
        public RefundBuilder status(RefundStatus status) {
            this.status = status;
            return this;
        }
        ...
        public Refund build() {
            return new Refund(refundId, paymentId, refAmount, reason, status, refundDate);
        }
    }
}

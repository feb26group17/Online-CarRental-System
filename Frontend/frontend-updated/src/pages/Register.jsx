...
function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const { fullName, email, phone, address, drivingLicense, adharCard, password } = formData;
      const res = await API.post('/auth/register/customer', { fullName, email, phone, address, drivingLicense, adharCard, password });
